...
<body class="bg-neutral-900">
    <div class="full-screen">
        <?php
            $links = [
                "Dashboard"=> "admin.php",
                'Dorms' => 'admin.php?page=manage-dormitory',
                'Managers' => 'admin.php?page=manage-managers',
                'Students' => 'admin.php?page=manage-students'
            ];
        ...
        <main class="">
            <?php
                ...
                switch($page) {
                    case 'manage-dormitory':
                        include './subpage/manage-dormitory.php';
                        break;
                    case 'manage-managers':
                        include './subpage/manage-manager.php';
                        break;
                    case 'manage-students':
                        include './subpage/manage-student.php';
                        break;
                    default:
