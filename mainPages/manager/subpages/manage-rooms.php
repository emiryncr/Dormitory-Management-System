    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="bg-neutral-300 rounded-lg sm:p-6 p-4 shadow-lg sm:min-w-96 max-w-64">
            ...
            <form action="" method="POST">
                ...
                <div class="sm:mt-4 mt-2">
                    <label for="roomRooms" class="block text-sm font-medium text-gray-700">Type of room</label>
                    <input type="text" id="roomRooms" name="roomRooms" class="mt-1 sm:p-2 p-1 border rounded w-full" required>
                </div>
                <div class="sm:mt-4 mt-2">
                    <label for="roomPhoto" class="block text-sm font-medium text-gray-700">Photo</label>
                    <input type="file" id="roomPhoto" name="roomPhoto" class="mt-1 sm:p-2 p-1 border rounded w-full bg-white text-gray-700" required>
                </div>
                <div class="sm:mt-4 mt-2">
